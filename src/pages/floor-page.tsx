  ...
  return (
    <div className="space-y-5 md:space-y-7">
      <section className="esports-card relative overflow-hidden rounded-2xl md:rounded-3xl">
        ...
        <div className="relative grid items-center gap-4 p-4 sm:min-h-[220px] sm:gap-6 sm:p-7 lg:grid-cols-[1.2fr_1fr] lg:p-9">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-electric/25 bg-electric/10 px-2.5 py-1 text-[10px] font-bold tracking-[0.15em] text-electric-soft uppercase sm:mb-4 sm:px-3">
              <Sparkles className="size-3" /> {data.settings.tagline}
            </div>
            <h1 className="max-w-2xl text-2xl leading-[0.95] font-extrabold tracking-[-0.045em] uppercase sm:text-5xl">
              <span className="text-electric-soft">Phoenix</span>
              <br />Gaming Zone
            </h1>
            <p className="mt-2 max-w-lg text-xs text-muted sm:mt-3 sm:text-sm">
